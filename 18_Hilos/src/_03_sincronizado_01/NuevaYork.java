...
public class NuevaYork {
	public static void main(String[] args){
		...
		/***
		 * ahora tengo tres fiestas y ahora a cada avenger le mando a una
		 * fiesta distinta, ahora cada hilo esta a atacando a diferentes
		 * posiciones de memoria y no se estan bloqueando.
		 * 
		 */
		...
		try { // se pone en try ctach porque el metodo sleep arroja una exception de tipo checked.
